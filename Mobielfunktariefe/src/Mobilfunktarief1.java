...
public class Mobilfunktarief1   {
	...
	public static void main (String[] args) {
		...
		int parameter_frage;					/* Zus�tzliche Parameter ? (1=JA/0=NEIN) */
		...
		eingabe = new Scanner(System.in);
			...
			//Mobitel
				...
				System.out.println("");
				System.out.println("--Die monatlichen Kosten f�r den Anbieter Mobitel sind:" + (8.99+ergebniss_minuten_mobitel+ergebniss_sms_mobitel) + "Euro pro Monat--");
				gesamt_mobitel = (8.99+ergebniss_minuten_mobitel+ergebniss_sms_mobitel);
					...
					System.out.println("");
					System.out.println("--Die monatlichen Kosten f�r den Anbieter Toptel sind:" + (14.99+ergebniss_minuten_toptel+ergebniss_sms_toptel) + "Euro pro Monat--");
					gesamt_toptel = (14.99+ergebniss_minuten_toptel+ergebniss_sms_toptel);
						...
						System.out.println("");
						System.out.println("--Die monatlichen Kosten f�r den Anbieter Tricatel sind:" + (19.99+ergebniss_minuten_tricatel+ergebniss_sms_tricatel) + "Euro pro Monat--");
						gesamt_tricatel = (19.99+ergebniss_minuten_tricatel+ergebniss_sms_tricatel);
							...
							System.out.println("--Die monatlichen Kosten f�r den Anbieter Fonmax sind:" +  gesamt_fonmax + Euro Pro pro Monat--");
						...
						System.out.println("");	
						System.out.println("");
						System.out.println("Wollen sie noch einen weiteren anbieter hinzuf�gen? (Ja=1/Nein=0)");
						parameter_frage = eingabe.nextInt();
							...
							if(parameter_frage == 1)
							{
								...
								System.out.println("geben sie bitte die monatliche grundgeb�hr ein(Bitte Komma anstadt Punkt, sonst Fehler):");
								...
								System.out.println("");
								System.out.println("--Die monatlichen Kosten f�r ihren Anbieter sind:" + (parameter_grundgebuehr+ergebniss_minuten_parameter+ergebniss_sms_parameter) + "Euro pro Monat--");
								...
								if(gesamt_mobitel < gesamt_toptel && gesamt_mobitel < gesamt_tricatel && gesamt_mobitel < gesamt_parameter && gesamt_mobitel < gesamt_fonmax)
								{
									...
									System.out.println("");
									System.out.println("");
									System.out.println("----Ihr g�nstigster Tarief ist: Mobitel.----");
									System.out.println("");
								...
								else if(gesamt_toptel < gesamt_mobitel && gesamt_toptel < gesamt_tricatel && gesamt_toptel < gesamt_parameter && gesamt_toptel < gesamt_fonmax)
								{
									...
									System.out.println("");
									System.out.println("");
									System.out.println("----Ihr g�nstigster Tarif ist: Toptel.----");
									System.out.println("");
									System.out.println("Jetzt Beginnt das Programm von vorne !");
								}
								else if(gesamt_tricatel < gesamt_mobitel && gesamt_tricatel < gesamt_toptel && gesamt_tricatel < gesamt_parameter && gesamt_tricatel < gesamt_fonmax)
								{
									...
									System.out.println("");
									System.out.println("");
									System.out.println("----Ihr g�nstigster Tarif ist: Tricatel.----");
									System.out.println("");
									System.out.println("Jetzt Beginnt das Programm von vorne !");
								}
								else if(gesamt_fonmax < gesamt_mobitel && gesamt_fonmax < gesamt_toptel && gesamt_fonmax < gesamt_tricatel && gesamt_fonmax < gesamt_parameter)
								{
									...
									System.out.println("");
									System.out.println("");
									System.out.println("----Ihr g�nstigster Tarif ist: Fonmax.----");
									System.out.println("");
									System.out.println("Jetzt Beginnt das Programm von vorne !");
								}
								else if(gesamt_parameter < gesamt_mobitel && gesamt_parameter < gesamt_toptel && gesamt_parameter < gesamt_tricatel && gesamt_parameter < gesamt_fonmax)
								{
									...
									System.out.println("");
									System.out.println("");
									System.out.println("----Ihr g�nstigster Tarif ist: Ihr zus�tzlich eingegebener Tarief.----");
									System.out.println("");
									System.out.println("Jetzt Beginnt das Programm von vorne !");
								}
